...
public class Manager7 {	
    ...
    static {	
        ...
        employee.add(new Employee("andorson", "s", 8000.20, List.of("e-com projects","Ticketing project","web-design project","sysapp project")));		employee.add(new Employee("rajesh", "s", 10000.20, List.of("e-com projects","Ticketing project","web-design project","sysapp project")));		employee.add(new Employee("kiruba", "k", 20000.20, List.of("e-com projects","Ticketing project","web-design project","sysapp project")));	} 	public static void main(String[] args) {	
        ...
        .collect(Collectors.toList());				listingempdetails.stream().forEach(t -> System.out.println(t));			
        System.out.println("=======================");			
